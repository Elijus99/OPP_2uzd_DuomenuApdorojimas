...
void isvedimas(std::list<stud> vargs, std::list<stud> ls, int VSize, int PSize, string GType)
{
	cout << "Vardas";
...
void SortToGroups(std::list<stud> &ls, std::list<stud> &vargs)
{
	std::list<stud>::iterator it = ls.begin();
	for (int i = 0; i < ls.size(); i++)
	{
...
void OutputToFiles(std::list<stud> ls, std::list<stud> vargs, string GType, int VSize, int PSize)
{
